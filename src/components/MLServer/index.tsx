...
export default function MLServer() {
  ...
  const serverSelect = api.mlServer.select.useMutation({
    onSuccess: () => {
      void serverGetAll.refetch()
      void messageAPI.success('Server selected')
    },
    onError: () => {
      void messageAPI.error('Server update failed')
    },
  })
  ...
  const serverUpdate = api.mlServer.update.useMutation({
    onSuccess: () => {
      void serverGetAll.refetch()
      void messageAPI.success('Server updated')
    },
    onError: () => {
      void messageAPI.error('Server update failed')
    },
  ...
  const serverDelete = api.mlServer.delete.useMutation({
    onSuccess: () => {
      void serverGetAll.refetch()
      void messageAPI.success('Server deleted')
    },
    onError: () => {
      void messageAPI.error('Server deletion failed')
    },
  })
