  ...
  return (
    <>
      ...
      <Container maxWidth="lg">
        <Card
          title={
            <Typography.Title level={4}>Drawing Type Map</Typography.Title>
          }>
          ...
          <Row gutter={[16, 16]}>
            ...
            {!drawingTypeGetAll.isFetching && (
              <>
                {drawingTypeGetAll?.data &&
                drawingTypeGetAll?.data?.length > 0 ? (
